...
public class DriveToSampleUseSlidesSpec extends CommandBase {
    private Follower follower;
    private Intake intakeSubsystem;
    private Limelight.SampleState buffer;
    private final Telemetry telemetry;

    public DriveToSampleUseSlidesSpec(Follower follower, Intake intakeSubsystem, Limelight.SampleState buffer, Telemetry telemetry) {
    ...
    public void initialize() {
        ...
        */
        ...
        intakeSubsystem.setExtension(kinematics.absoluteSlidePosition - 80);
    }
